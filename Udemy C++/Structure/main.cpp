...
int main ()
{
full_name my_name=full_name("Maryam","Taha");

cout<<my_name.last<<"\n";
my_name=full_name("Maryam","Nono");
cout<<my_name.last<<"\n";
	cout<<my_name.middle;
...
int main ()
{
	...
	cout<<"Library menu : "<<"\n";
	cout<<"1)  add_book"<<"\n";
	cout<<"2)  search a book by prefix"<<"\n";
	cout<<"3)  print books borrowed by name "<<"\n";
	...
	cout<<"9)  print users"<<"\n";
	cout<<"10) EXIT"<<"\n";
	cout<<"Enter your menu choice from [1 - 10 ]: ";
	cin>menu_n;
return 0;}
*/
#include<iostream>
